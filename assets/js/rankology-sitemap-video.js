...
jQuery(document).ready(function ($) {
    function rankology_call_media_uploader() {
        var mediaUploader;
        var thumb;
        $(".rankology_video_thumbnail_upload").click(function (e) {
            e.preventDefault();
            $btn = $(this);
    ...
    function rankology_call_video_accordion() {
    ...
    rankology_call_video_accordion();
    ...
    $("#add-video").click(function () {
        ...
        var section = template
            ...
            .each(function () {
                ...
                //Clear input value
                if (!$(this).hasClass("rankology_video_thumbnail_upload")) {
                    $(this).attr("value", "");
                }
                ...
                if ($(this).is(":checkbox")) {
                    ...
                    $(this).hasClass("rankology_video_thumbnail_upload")
                ) {
                    //do nothing
                } else {
                    $(this)
