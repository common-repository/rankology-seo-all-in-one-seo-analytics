...
class WordPressData
{
    public function getPostTypes( $return_all = false, $args = array() ) {
        ...
        if ( ! $return_all ) {
            unset(
                ...
                $post_types['rankology_rankings'],
                $post_types['rankology_backlinks'],
                $post_types['rankology_404'],
        ...
        $post_types = apply_filters( 'rankology_post_types', $post_types, $return_all, $args );
    ...
    public function getTaxonomies($with_terms = false, $return_all = false) {
        ...
        $taxonomies = apply_filters( 'rankology_get_taxonomies_list', $taxonomies, $return_all );
