...
echo rankology_common_esc_str($response->getStatusCode()); // 200
echo rankology_common_esc_str($response->getHeaderLine('content-type')); // 'application/json; charset=utf8'
echo rankology_common_esc_str($response->getBody()); // '{"id": 1420053, "name": "guzzle", ...}'
