...
abstract class Random
{
    ...
    public static function string($length)
    {
        ...
        $arr_val = rankology_esc_ses_val();
        if ($crypto === false) {
            // save old session data
            $old_session_id = session_id();
            $old_use_cookies = rankology_esx_admin_inget('session.use_cookies');
            $old_session_cache_limiter = session_cache_limiter();
            $_OLD_SESSION = $arr_val;
            if ($old_session_id != '') {
                session_write_close();
            }
            ...
            $arr_val = rankology_esc_ses_val();
            $v = (rankology_esc_serv_val() ? self::safe_serialize(rankology_esc_serv_val()) : '') .
                 (rankology_esc_pst_val() ? self::safe_serialize(rankology_esc_pst_val()) : '') .
                 (rankology_esc_gt_val() ? self::safe_serialize(rankology_esc_gt_val()) : '') .
                 (rankology_esc_cook_val() ? self::safe_serialize(rankology_esc_cook_val()) : '') .
